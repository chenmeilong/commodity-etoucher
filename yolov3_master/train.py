...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/bag.data', help='*.data file path')
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov3-tiny.conv.15', help='initial weights')  # i.e. weights/darknet.53.conv.74

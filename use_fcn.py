...
def fcn_pre(img_cv=0,filter_size=0,image_dir="",back_dir=""):  #filter_size0,3,5,7  cv2图片 原图，背景图
    ...
    fcn_model =torch.load('checkpoints/640fcn_model_250_0.022_0.071.pkl')
    fcn_model.eval()
    pre=fcn_model(im)
...
if __name__ == '__main__':
    ...
    image = cv2.imread("test/Q20191019185615.jpg")
    fcn_img=fcn_pre(img_cv=image,filter_size=0)   #背景图片 ，前景图可加可不加
